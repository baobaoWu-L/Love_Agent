...
<p align="center"><strong>LoveFlow Code: Where Models and Agents Co-Evolve</strong></p>

<p align="center">
  <a href="https://loveflow.dev">Website</a> | <a href="https://loveflow.dev/blog">Blog</a> | <a href="https://github.com/XiaomiMiMo/LoveFlow-Code">GitHub</a>
</p>

---

LoveFlowCode is a terminal-native AI coding assistant. It can read and write code, run commands, manage Git, and use a persistent memory system to keep a deep understanding of your project across sessions while continuously improving itself.

MiMo Auto is built in as a free-for-limited-time channel, so you can start with zero configuration. LoveFlowCode also supports connecting to any mainstream LLM provider API.
...
```bash
# One-line install
curl -fsSL https://loveflow.dev/install | bash

# Or install via npm
npm install -g @loveflow-ai/cli
...
LoveFlowCode is configured via `.loveflow/loveflow.json` in the project directory (or `~/.config/loveflow/loveflow.json` globally). Key options include:
...
Source code is licensed under the [MIT License](https://github.com/XiaomiMiMo/LoveFlow-Code/blob/main/LICENSE).

Use of LoveFlowCode is also subject to the [Use Restrictions](https://github.com/XiaomiMiMo/LoveFlow-Code/blob/main/USE_RESTRICTIONS.md).
