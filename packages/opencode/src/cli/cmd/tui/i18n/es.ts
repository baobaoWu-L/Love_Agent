...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar LoveFlowCode, aceptas nuestros ",
  ...
  "tui.tips.mcp_oauth":
    "LoveFlowCode gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  ...
  "tui.tips.formatter": "LoveFlowCode formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "LoveFlowCode usa servidores LSP para análisis inteligente de código",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a LoveFlowCode leer archivos sensibles",
  "tui.tips.run":
  ...
  "tui.tips.serve":
    "Ejecuta {highlight}mimo serve{/highlight} para acceso headless a la API de LoveFlowCode",
  ...
  "tui.toast.update_available.success": "Se actualizó a LoveFlowCode v{{version}}. Por favor reinicie la aplicación.",
