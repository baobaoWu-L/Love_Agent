...
export const dict = {
  ...
  "tui.home.agreement.prefix": "LoveFlowCode をご利用いただくことで、",
  ...
  "tui.tips.mcp_oauth": "LoveFlowCode は認証が必要なリモート MCP サーバの OAuth を自動処理します",
  ...
  "tui.tips.formatter": "LoveFlowCode は prettier、gofmt、ruff などでファイルを自動整形します",
  ...
  "tui.tips.lsp": "LoveFlowCode はインテリジェントなコード解析に LSP サーバを使います",
  ...
  "tui.tips.plugin_protect": "プラグインを書いて LoveFlowCode が機密ファイルを読まないようにできます",
  ...
  "tui.tips.serve": "{highlight}mimo serve{/highlight} を実行するとヘッドレスで LoveFlowCode API にアクセスできます",
  ...
  "tui.toast.update_available.success": "LoveFlowCode v{{version}} に更新しました。アプリケーションを再起動してください。",
