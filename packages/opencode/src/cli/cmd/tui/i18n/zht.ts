...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 LoveFlowCode 即表示你同意我們的",
  ...
  "tui.tips.mcp_oauth": "LoveFlowCode 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  ...
  "tui.tips.formatter": "LoveFlowCode 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "LoveFlowCode 使用 LSP 伺服器進行智慧程式碼分析",
  ...
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 LoveFlowCode 讀取敏感檔案",
  ...
  "tui.tips.serve": "執行 {highlight}mimo serve{/highlight} 以無介面模式提供 LoveFlowCode API",
  ...
  "tui.toast.update_available.success": "已更新到 LoveFlowCode v{{version}}，請重新啟動應用程式。",
