...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 LoveFlowCode 即表示你同意我们的",
  ...
  "tui.tips.mcp_oauth": "LoveFlowCode 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  ...
  "tui.tips.formatter": "LoveFlowCode 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "LoveFlowCode 使用 LSP 服务器进行智能代码分析",
  ...
  "tui.tips.plugin_protect": "写一个插件阻止 LoveFlowCode 读取敏感文件",
  ...
  "tui.tips.serve": "运行 {highlight}mimo serve{/highlight} 以无头模式提供 LoveFlowCode API",
  ...
  "tui.toast.update_available.success": "已更新到 LoveFlowCode v{{version}}，请重启应用。",
