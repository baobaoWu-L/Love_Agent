...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant LoveFlowCode, vous acceptez nos ",
  ...
  "tui.tips.mcp_oauth":
    "LoveFlowCode gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  ...
  "tui.tips.formatter": "LoveFlowCode formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "LoveFlowCode utilise des serveurs LSP pour une analyse de code intelligente",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher LoveFlowCode de lire des fichiers sensibles",
  ...
  "tui.tips.serve": "Exécutez {highlight}mimo serve{/highlight} pour exposer l'API LoveFlowCode en mode headless",
  ...
  "tui.toast.update_available.success": "Mis à jour vers LoveFlowCode v{{version}}. Veuillez redémarrer l'application.",
