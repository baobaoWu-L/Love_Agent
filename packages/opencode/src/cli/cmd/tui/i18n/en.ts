export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using LoveFlowCode, you agree to our ",
  ...
  "tui.tips.mcp_oauth": "LoveFlowCode auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "tui.tips.formatter": "LoveFlowCode auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "LoveFlowCode uses LSP servers for intelligent code analysis",
  ...
  "tui.tips.plugin_protect": "Create a plugin to prevent LoveFlowCode from reading sensitive files",
  ...
  "tui.tips.serve": "Run {highlight}mimo serve{/highlight} for headless API access to LoveFlowCode",
  ...
  "tui.toast.update_available.success": "Successfully updated to LoveFlowCode v{{version}}. Please restart the application.",
