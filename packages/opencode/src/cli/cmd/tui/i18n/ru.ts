...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Используя LoveFlowCode, вы соглашаетесь с нашими ",
  ...
  "tui.tips.mcp_oauth":
    "LoveFlowCode автоматически обрабатывает OAuth для удалённых MCP-серверов с авторизацией",
  ...
  "tui.tips.formatter":
    "LoveFlowCode автоматически форматирует файлы с помощью prettier, gofmt, ruff и других инструментов",
  ...
  "tui.tips.lsp": "LoveFlowCode использует LSP-серверы для интеллектуального анализа кода",
  ...
  "tui.tips.plugin_protect":
    "Создайте плагин, который запретит LoveFlowCode читать чувствительные файлы",
  "tui.tips.run":
  ...
  "tui.tips.serve":
    "Запустите {highlight}mimo serve{/highlight} для headless-доступа к API LoveFlowCode",
  ...
  "tui.toast.update_available.success": "Обновлено до LoveFlowCode v{{version}}. Пожалуйста, перезапустите приложение.",
