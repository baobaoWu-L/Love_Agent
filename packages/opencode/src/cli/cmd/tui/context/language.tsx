...
import { I18nProvider } from "@loveflow-ai/ui/context/i18n"
...
const loaders: Record<Exclude<Locale, "en">, () => Promise<Dictionary>> = {
  zh: () => merge(import("@loveflow-ai/ui/i18n/zh"), import("../i18n/zh")),
  zht: () => merge(import("@loveflow-ai/ui/i18n/zht"), import("../i18n/zht")),
  ko: () => merge(import("@loveflow-ai/ui/i18n/ko")),
  de: () => merge(import("@loveflow-ai/ui/i18n/de")),
  es: () => merge(import("@loveflow-ai/ui/i18n/es"), import("../i18n/es")),
  fr: () => merge(import("@loveflow-ai/ui/i18n/fr"), import("../i18n/fr")),
  da: () => merge(import("@loveflow-ai/ui/i18n/da")),
  ja: () => merge(import("@loveflow-ai/ui/i18n/ja"), import("../i18n/ja")),
  pl: () => merge(import("@loveflow-ai/ui/i18n/pl")),
  ru: () => merge(import("@loveflow-ai/ui/i18n/ru"), import("../i18n/ru")),
  ar: () => merge(import("@loveflow-ai/ui/i18n/ar")),
  no: () => merge(import("@loveflow-ai/ui/i18n/no")),
  br: () => merge(import("@loveflow-ai/ui/i18n/br")),
  th: () => merge(import("@loveflow-ai/ui/i18n/th")),
  bs: () => merge(import("@loveflow-ai/ui/i18n/bs")),
  tr: () => merge(import("@loveflow-ai/ui/i18n/tr")),
}
