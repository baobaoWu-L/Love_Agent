...
import { Script } from "@loveflow-ai/script"
...
for (const item of targets) {
  ...
  await Bun.file(`dist/${name}/README.md`).write(
    `This is the ${item.os}-${item.arch} binary for [@loveflow-ai/cli](https://www.npmjs.com/package/@loveflow-ai/cli). Install that package directly.\n`,
  )
  await Bun.file(`dist/${name}/package.json`).write(
    JSON.stringify(
      {
        name: `@loveflow-ai/${name}`,
        version: Script.version,
        description: "Platform-specific binary for @loveflow-ai/cli.",
        license: "MIT",
        author: "Xiaomi MiMo Team",
        homepage: "https://mimo.xiaomi.com/coder",
        repository: {
          type: "git",
          url: "git+https://github.com/XiaomiMiMo/LoveFlow-Code.git",
        },
