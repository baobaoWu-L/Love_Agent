...
beforeAll(async () => {
  ...
  mock.module("@loveflow-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@loveflow-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@loveflow-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@loveflow-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
